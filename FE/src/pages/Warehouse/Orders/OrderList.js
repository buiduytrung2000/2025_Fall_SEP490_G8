...
export default function OrderList() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("warehouse-order:created", onCreated);
  }, []);
              ...
              {loading ? (
                ...
                orders.map((order, index) => (
                  <TableRow key={order.order_id} hover>
                    ...
                    <TableCell>{formatOrderCode(order)}</TableCell>
                    ...
                    <TableCell align="center">
                      <IconButton
                        onClick={() =>
                          navigate(`/warehouse/orders/${order.order_id}`)
                        }
                        title="Xem chi tiết"
                      >
                        <ViewIcon />
